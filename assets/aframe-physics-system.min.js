...
()({
    1: [function (require, module, exports) {
            ...
            "./src/components/ammo-constraint": 9,
            "./src/components/body/ammo-body": 10,
            "./src/components/body/body": 11,
            "./src/components/body/dynamic-body": 12,
            "./src/components/body/static-body": 13,
            "./src/components/constraint": 14,
            "./src/components/math": 15,
            "./src/components/shape/ammo-shape": 17,
            "./src/components/shape/shape": 18,
            "./src/components/spring": 19,
            "./src/system": 29,
            "cannon-es": 5
        }
    ],
    2: [function (require, module, exports) {
            ...
            CANNON.shape2mesh = function (body) {
                ...
                function createBufferGeometry(positions, faces) {
                    ...
                    return geometry.setAttribute("position", new THREE.Float32BufferAttribute(positions, 3)),
                ...
                for (var l = 0; l < body.shapes.length; l++) {
                    ...
                    case CANNON.Shape.types.CONVEXPOLYHEDRON:
                        for (var positions = [], i = 0; i < shape.vertices.length; i++) {
                    ...
                    case CANNON.Shape.types.HEIGHTFIELD:
                        for (var v0 = new CANNON.Vec3, v1 = new CANNON.Vec3, v2 = new CANNON.Vec3, xi = (positions = [], faces = [], 0); xi < shape.data.length - 1; xi++)
                            for (var yi = 0; yi < shape.data[xi].length - 1; yi++)
                                for (var k = 0; k < 2; k++) {
                                    ...
                                    i = positions.length / 3 - 3;
                                    faces.push(i, i + 1, i + 2)
                                }
                        geometry = createBufferGeometry(positions, faces);
                        mesh = new THREE.Mesh(geometry, this.currentMaterial);
                        break;
                    case CANNON.Shape.types.TRIMESH:
                        for (geometry = new THREE.BufferGeometry, v0 = new CANNON.Vec3, v1 = new CANNON.Vec3, v2 = new CANNON.Vec3, positions = [], faces = [], i = 0; i < shape.indices.length / 3; i++) {
                            shape.getTriangleVertices(i, v0, v1, v2),
                            positions.push(v0.x, v0.y, v0.z, v1.x, v1.y, v1.z, v2.x, v2.y, v2.z);
                            j = positions.length / 3 - 3;
                        ...
                        for (i = 0; i < mesh.children.length; i++)
                            if (mesh.children[i].castShadow = !0, mesh.children[i].receiveShadow = !0, mesh.children[i])
                                for (j = 0; j < mesh.children[i].length; j++)
                                    mesh.children[i].children[j].castShadow = !0, mesh.children[i].children[j].receiveShadow = !0;
    ...
    3: [function (require, module, exports) {
            AFRAME.registerComponent("stats-panel", {
                ...
                init() {
                    ...
                    if (container && this.data.merge)
                        return void(this.container = container);
                    this.base = document.createElement("div"),
                    this.base.classList.add("rs-base");
                    const body = document.body || document.getElementsByTagName("body")[0];
                    container && !this.data.merge && (this.base.style.top = "auto", this.base.style.bottom = "20px"),
            ...
            AFRAME.registerComponent("stats-row", {
                ...
                init() {
                    ...
                    groupComponent = this.el.components[groupComponentName] || this.el.sceneEl.components[groupComponentName] || this.el.components["stats-group"] || this.el.sceneEl.components["stats-group"];
                    groupComponent ? (this.counter = document.createElement("div"), this.counter.classList.add("rs-counter-base"), groupComponent.group.appendChild(this.counter), this.counterId = document.createElement("div"), this.counterId.classList.add("rs-counter-id"), this.counterId.innerHTML = this.data.label, this.counter.appendChild(this.counterId), this.counterValues = {}, this.data.properties.forEach(property => {
                        ...
                        }), this.updateData = this.updateData.bind(this), this.el.addEventListener(this.data.event, this.updateData), this.splitCache = {}) : console.warn(`Couldn't find stats group ${groupComponentName}`)
                },
                updateData(e) {
                ...
                splitDot(path) {
                    return path in this.splitCache ? this.splitCache[path] : (this.splitCache[path] = path.split("."), this.splitCache[path])
                }
            }),
            AFRAME.registerComponent("stats-collector", {
                ...
                statsReceived(e) {
                    ...
                    this.counter++,
                    this.counter === this.data.outputFrequency && (this.outputData(), this.resetData())
                },
                updateData(detail) {
                    this.data.properties.forEach(property => {
                        let value = detail;
                ...
                outputData() {
                    ...
                    this.data.outEvent && this.el.emit(this.data.outEvent, this.outputDetail),
                ...
                computeOutput(outputInstruction, data) {
                    ...
                    case "percentile":
                        ...
                        proportion = +outputInstructions[1].replace("_", ".") / 100,
                        position = (data.length - 1) * proportion,
                        base = Math.floor(position),
                        delta = position - base;
                        output = void 0 !== sorted[base + 1] ? sorted[base] + delta * (sorted[base + 1] - sorted[base]) : sorted[base]
                    }
    ...
    4: [function (require, module, exports) {
            ...
            THREE.AmmoDebugDrawer = function (scene, world, options) {
                ...
                drawOnTop && (this.mesh.renderOrder = 999),
    ...
    5: [function (require, module, exports) {
            ...
            Mat3 = function () {
                ...
                _proto.mmult = function (matrix, target) {
                    ...
                    for (var elements = matrix.elements, i = 0; i < 3; i++)
                        for (var j = 0; j < 3; j++) {
                            for (var sum = 0, k = 0; k < 3; k++)
                                sum += elements[i + 3 * k] * this.elements[k + 3 * j];
                ...
                _proto.scale = function (vector, target) {
                    ...
                    for (var e = this.elements, t = target.elements, i = 0; 3 !== i; i++)
                        t[3 * i + 0] = vector.x * e[3 * i + 0], t[3 * i + 1] = vector.y * e[3 * i + 1], t[3 * i + 2] = vector.z * e[3 * i + 2];
                    return target
                },
                _proto.solve = function (b, target) {
                    ...
                    if (target.z = eqns[11] / eqns[10], target.y = (eqns[7] - eqns[6] * target.z) / eqns[5], target.x = (eqns[3] - eqns[2] * target.z - eqns[1] * target.y) / eqns[0], isNaN(target.x) || isNaN(target.y) || isNaN(target.z) || target.x === 1 / 0 || target.y === 1 / 0 || target.z === 1 / 0)
                ...
                _proto.reverse = function (target) {
                    ...
                    do {
                        j = 2;
                        do {
                            if (p = eqns[3 + j + 6 * i], isNaN(p) || p === 1 / 0)
            ...
            Vec3 = function () {
                ...
                _proto.unit = function (target) {
                    ...
                    return ninv > 0 ? (ninv = 1 / ninv, target.x = x * ninv, target.y = y * ninv, target.z = z * ninv) : (target.x = 1, target.y = 0, target.z = 0),
                    target
                },
                ...
                _proto.vmul = function (vector, target) {
                    return void 0 === target && (target = new Vec3),
                    target.x = vector.x * this.x,
                    target.y = vector.y * this.y,
                    target.z = vector.z * this.z,
                    target
                ...
                _proto.tangents = function (t1, t2) {
                    ...
                    if (norm > 0) {
                        ...
                        Math.abs(n.x) < .9 ? (randVec.set(1, 0, 0), n.cross(randVec, t1)) : (randVec.set(0, 1, 0), n.cross(randVec, t1)),
                        n.cross(t1, t2)
                    } else
                        t1.set(1, 0, 0), t2.set(0, 1, 0)
                },
                _proto.toString = function () {
                ...
                _proto.almostEquals = function (vector, precision) {
                    ...
                    !(Math.abs(this.x - vector.x) > precision || Math.abs(this.y - vector.y) > precision || Math.abs(this.z - vector.z) > precision)
                },
                ...
                _proto.isAntiparallelTo = function (vector, precision) {
                    ...
                    antip_neg.almostEquals(vector, precision)
                },
            ...
            AABB = function () {
                ...
                return _proto.setFromPoints = function (points, position, quaternion, skinSize) {
                    ...
                    return position && (position.vadd(l, l), position.vadd(u, u)),
                    skinSize && (l.x -= skinSize, l.y -= skinSize, l.z -= skinSize, u.x += skinSize, u.y += skinSize, u.z += skinSize),
                    this
                },
                ...
                _proto.overlapsRay = function (ray) {
                    ...
                    from = ray.from,
                    dirFracX = 1 / direction.x,
                    dirFracY = 1 / direction.y,
                    dirFracZ = 1 / direction.z,
                    t1 = (this.lowerBound.x - from.x) * dirFracX,
                    t2 = (this.upperBound.x - from.x) * dirFracX,
                    t3 = (this.lowerBound.y - from.y) * dirFracY,
                    t4 = (this.upperBound.y - from.y) * dirFracY,
                    t5 = (this.lowerBound.z - from.z) * dirFracZ,
                    t6 = (this.upperBound.z - from.z) * dirFracZ,
            ...
            Quaternion = function () {
                ...
                _proto.toAxisAngle = function (targetAxis) {
                    void 0 === targetAxis && (targetAxis = new Vec3),
                    this.normalize();
                    var angle = 2 * Math.acos(this.w),
                    s = Math.sqrt(1 - this.w * this.w);
                    return s < .001 ? (targetAxis.x = this.x, targetAxis.y = this.y, targetAxis.z = this.z) : (targetAxis.x = this.x / s, targetAxis.y = this.y / s, targetAxis.z = this.z / s),
                    [targetAxis, angle]
                },
                ...
                _proto.conjugate = function (target) {
                    return void 0 === target && (target = new Quaternion),
                    target.x = -this.x,
                    target.y = -this.y,
                    target.z = -this.z,
                    target.w = this.w,
                ...
                _proto.normalize = function () {
                    ...
                    return 0 === l ? (this.x = 0, this.y = 0, this.z = 0, this.w = 0) : (l = 1 / l, this.x *= l, this.y *= l, this.z *= l, this.w *= l),
                    this
                },
                _proto.normalizeFast = function () {
                    var f = (3 - (this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w)) / 2;
                    return 0 === f ? (this.x = 0, this.y = 0, this.z = 0, this.w = 0) : (this.x *= f, this.y *= f, this.z *= f, this.w *= f),
                    this
                },
                _proto.vmult = function (v, target) {
                    void 0 === target && (target = new Vec3);
                ...
                _proto.toEuler = function (target, order) {
                    ...
                    case "YZX":
                        var test = x * y + z * w;
                        if (test > .499 && (heading = 2 * Math.atan2(x, w), attitude = Math.PI / 2, bank = 0), test <  - .499 && (heading = -2 * Math.atan2(x, w), attitude = -Math.PI / 2, bank = 0), void 0 === heading) {
                            var sqx = x * x,
                            sqy = y * y,
                            sqz = z * z;
                ...
                _proto.setFromEuler = function (x, y, z, order) {
                    ...
                    s2 = Math.sin(y / 2),
                    s3 = Math.sin(z / 2);
                    return "XYZ" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "YXZ" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3) : "ZXY" === order ? (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "ZYX" === order ? (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3) : "YZX" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "XZY" === order && (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3),
                    this
                },
                _proto.clone = function () {
                ...
                _proto.slerp = function (toQuat, t, target) {
                    ...
                    bz = toQuat.z,
                    bw = toQuat.w;
                    return (cosom = ax * bx + ay * by + az * bz + aw * bw) < 0 && (cosom = -cosom, bx = -bx, by = -by, bz = -bz, bw = -bw),
                    1 - cosom > 1e-6 ? (omega = Math.acos(cosom), sinom = Math.sin(omega), scale0 = Math.sin((1 - t) * omega) / sinom, scale1 = Math.sin(t * omega) / sinom) : (scale0 = 1 - t, scale1 = t),
            ...
            var Transform = function () {
                ...
                _proto.vectorToWorldFrame = function (localVector, result) {
                    return void 0 === result && (result = new Vec3),
            ...
            ConvexPolyhedron = function (_Shape) {
                function ConvexPolyhedron(props) {
                    var _this;
                    void 0 === props && (props = {});
                    var _props = props,
                    _props$vertices = _props.vertices,
                    vertices = void 0 === _props$vertices ? [] : _props$vertices,
                    _props$faces = _props.faces,
                    faces = void 0 === _props$faces ? [] : _props$faces,
                    _props$normals = _props.normals,
                    normals = void 0 === _props$normals ? [] : _props$normals,
                    axes = _props.axes,
                    ...
                    0 === _this.faceNormals.length && _this.computeNormals(),
                    boundingSphereRadius ? _this.boundingSphereRadius = boundingSphereRadius : _this.updateBoundingSphereRadius(),
                    _this.worldVertices = [],
                    _this.worldVerticesNeedsUpdate = !0,
                    _this.worldFaceNormals = [],
                    _this.worldFaceNormalsNeedsUpdate = !0,
                ...
                return _proto.computeEdges = function () {
                    ...
                    edges = this.uniqueEdges;
                    edges.length = 0;
                    for (var edge = new Vec3, i = 0; i !== faces.length; i++)
                ...
                _proto.findSeparatingAxis = function (hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
                    ...
                    if (this.uniqueAxes)
                        for (var _i = 0; _i !== this.uniqueAxes.length; _i++) {
                    ...
                    if (hullB.uniqueAxes)
                        ...
                        for (var numFacesB = faceListB ? faceListB.length : hullB.faces.length, _i2 = 0; _i2 < numFacesB; _i2++) {
                ...
                _proto.calculateLocalInertia = function (mass, target) {
                    ...
                    y = aabbmax.y - aabbmin.y,
                    z = aabbmax.z - aabbmin.z;
                ...
                _proto.clipFaceAgainstHull = function (separatingNormal, posA, quatA, worldVertsB1, minDist, maxDist, result) {
                    ...
                    if (!(closestFaceA < 0)) {
                        ...
                        for (var i = 0; i < this.faces.length; i++)
                            for (var j = 0; j < this.faces[i].length; j++)
                                 - 1 !== polyA.indexOf(this.faces[i][j]) && i !== closestFaceA && -1 === polyA.connectedFaces.indexOf(i) && polyA.connectedFaces.push(i);
                        for (var numVerticesA = polyA.length, _i4 = 0; _i4 < numVerticesA; _i4++) {
                            var a = this.vertices[polyA[_i4]],
                            b = this.vertices[polyA[(_i4 + 1) % numVerticesA]];
                            a.vsub(b, edge0),
                            ...
                            for (this.clipFaceAgainstPlane(pVtxIn, pVtxOut, planeNormalWS, _planeEqWS); pVtxIn.length; )
                                pVtxIn.shift();
                            for (; pVtxOut.length; )
                ...
                _proto.computeWorldVertices = function (position, quat) {
                    ...
                    for (var verts = this.vertices, worldVerts = this.worldVertices, i = 0; i !== this.vertices.length; i++)
                        quat.vmult(verts[i], worldVerts[i]), position.vadd(worldVerts[i], worldVerts[i]);
                ...
                _proto.calculateWorldAABB = function (pos, quat, min, max) {
                    for (var minx, miny, minz, maxx, maxy, maxz, verts = this.vertices, tempWorldVertex = new Vec3, i = 0; i < verts.length; i++) {
                        ...
                        (void 0 === minx || v.x < minx) && (minx = v.x),
                        (void 0 === maxx || v.x > maxx) && (maxx = v.x),
                        (void 0 === miny || v.y < miny) && (miny = v.y),
                        (void 0 === maxy || v.y > maxy) && (maxy = v.y),
                        (void 0 === minz || v.z < minz) && (minz = v.z),
                        (void 0 === maxz || v.z > maxz) && (maxz = v.z)
                    }
                ...
                _proto.getAveragePointLocal = function (target) {
                    void 0 === target && (target = new Vec3);
                    for (var verts = this.vertices, i = 0; i < verts.length; i++)
                        target.vadd(verts[i], target);
                    return target.scale(1 / verts.length, target),
                    target
                },
            ...
            var Box = function (_Shape) {
                ...
                return _proto.updateConvexPolyhedronRepresentation = function () {
                    ...
                    axes = [new V(0, 0, 1), new V(0, 1, 0), new V(1, 0, 0)],
                    h = new ConvexPolyhedron({
                        vertices: vertices,
                ...
                _proto.forEachWorldCorner = function (pos, quat, callback) {
                    for (var e = this.halfExtents, corners = [[e.x, e.y, e.z], [-e.x, e.y, e.z], [-e.x, -e.y, e.z], [-e.x, -e.y, -e.z], [e.x, -e.y, -e.z], [e.x, e.y, -e.z], [-e.x, e.y, -e.z], [e.x, -e.y, e.z]], i = 0; i < corners.length; i++)
                        worldCornerTempPos.set(corners[i][0], corners[i][1], corners[i][2]), quat.vmult(worldCornerTempPos, worldCornerTempPos), pos.vadd(worldCornerTempPos, worldCornerTempPos), callback(worldCornerTempPos.x, worldCornerTempPos.y, worldCornerTempPos.z)
                },
                _proto.calculateWorldAABB = function (pos, quat, min, max) {
            ...
            Body = function (_EventTarget) {
                function Body(options) {
                    var _this;
                    void 0 === options && (options = {}),
                    (_this = _EventTarget.call(this) || this).id = Body.idCounter++,
                    _this.index = -1,
                    _this.world = null,
                    _this.preStep = null,
                    _this.postStep = null,
                    _this.vlambda = new Vec3,
                    _this.collisionFilterGroup = "number" == typeof options.collisionFilterGroup ? options.collisionFilterGroup : 1,
                    ...
                    options.position && (_this.position.copy(options.position), _this.previousPosition.copy(options.position), _this.interpolatedPosition.copy(options.position), _this.initPosition.copy(options.position)),
                    _this.velocity = new Vec3,
                    options.velocity && _this.velocity.copy(options.velocity),
                    _this.initVelocity = new Vec3,
                    _this.force = new Vec3;
                    var mass = "number" == typeof options.mass ? options.mass : 0;
                    return _this.mass = mass,
                    _this.invMass = mass > 0 ? 1 / mass : 0,
                    _this.material = options.material || null,
                    _this.linearDamping = "number" == typeof options.linearDamping ? options.linearDamping : .01,
                    _this.type = mass <= 0 ? Body.STATIC : Body.DYNAMIC,
                    typeof options.type == typeof Body.STATIC && (_this.type = options.type),
                    _this.allowSleep = void 0 === options.allowSleep || options.allowSleep,
                    _this.sleepState = 0,
                    _this.sleepSpeedLimit = void 0 !== options.sleepSpeedLimit ? options.sleepSpeedLimit : .1,
                    _this.sleepTimeLimit = void 0 !== options.sleepTimeLimit ? options.sleepTimeLimit : 1,
                    _this.timeLastSleepy = 0,
                    _this.wakeUpAfterNarrowphase = !1,
                    ...
                    options.quaternion && (_this.quaternion.copy(options.quaternion), _this.initQuaternion.copy(options.quaternion), _this.previousQuaternion.copy(options.quaternion), _this.interpolatedQuaternion.copy(options.quaternion)),
                    ...
                    _this.fixedRotation = void 0 !== options.fixedRotation && options.fixedRotation,
                    _this.angularDamping = void 0 !== options.angularDamping ? options.angularDamping : .01,
                    _this.linearFactor = new Vec3(1, 1, 1),
                    options.linearFactor && _this.linearFactor.copy(options.linearFactor),
                    _this.angularFactor = new Vec3(1, 1, 1),
                    options.angularFactor && _this.angularFactor.copy(options.angularFactor),
                    _this.aabb = new AABB,
                    _this.aabbNeedsUpdate = !0,
                    _this.boundingRadius = 0,
                    _this.wlambda = new Vec3,
                    options.shape && _this.addShape(options.shape),
                ...
                return _proto.wakeUp = function () {
                    ...
                    prevState === Body.SLEEPING && this.dispatchEvent(Body.wakeupEvent)
                },
                ...
                _proto.sleepTick = function (time) {
                    if (this.allowSleep) {
                        ...
                        speedSquared = this.velocity.lengthSquared() + this.angularVelocity.lengthSquared(),
            ...
            var tmpVec = new Vec3,
            tmpQuat$1 = new Quaternion,
            computeAABB_shapeAABB = new AABB,
            uiw_m1 = new Mat3,
            uiw_m2 = new Mat3,
            Body_applyForce_rotForce = (new Mat3, new Vec3),
            ...
            Broadphase = function () {
                ...
                _proto.setWorld = function (world) {},
            ...
            Broadphase_makePairsUnique_temp = (new Vec3, new Quaternion, new Vec3, {
                keys: []
            }),
            ...
            var GridBroadphase = function (_Broadphase) {
                function GridBroadphase(aabbMin, aabbMax, nx, ny, nz) {
                    var _this;
                    void 0 === aabbMin && (aabbMin = new Vec3(100, 100, 100)),
                    void 0 === aabbMax && (aabbMax = new Vec3(-100, -100, -100)),
                    void 0 === nx && (nx = 10),
                    void 0 === ny && (ny = 10),
                    void 0 === nz && (nz = 10),
                    (_this = _Broadphase.call(this) || this).nx = nx,
                    _this.ny = ny,
                    _this.nz = nz,
                ...
                GridBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
                    ...
                    for (var _i = 0; _i !== N; _i++) {
                        ...
                        case PLANE:
                            ...
                            var planeNormal = _shape.worldNormal,
                    ...
                    for (var _i2 = 0; _i2 !== Nbins; _i2++) {
                        ...
                        if (binLength > 1)
                            for (var bin = bins[_i2], _xi = 0; _xi !== binLength; _xi++)
                                for (var _bi = bin[_xi], _yi = 0; _yi !== _xi; _yi++) {
                                    var bj = bin[_yi];
            ...
            NaiveBroadphase = (new Vec3, function (_Broadphase) {
                ...
                return _proto.collisionPairs = function (world, pairs1, pairs2) {
                    for (var bi, bj, bodies = world.bodies, n = bodies.length, i = 0; i !== n; i++)
                        for (var j = 0; j !== i; j++)
                            bi = bodies[i], bj = bodies[j], this.needBroadphaseCollision(bi, bj) && this.intersectionTest(bi, bj, pairs1, pairs2)
                },
                _proto.aabbQuery = function (world, aabb, result) {
            ...
            Ray = function () {
                function Ray(from, to) {
                    void 0 === from && (from = new Vec3),
                    void 0 === to && (to = new Vec3),
                ...
                _proto.intersectBody = function (body, result) {
                    ...
                    if ((!checkCollisionResponse || body.collisionResponse) && 0 != (this.collisionFilterGroup & body.collisionFilterMask) && 0 != (body.collisionFilterGroup & this.collisionFilterMask))
                        for (var xi = intersectBody_xi, qi = intersectBody_qi, i = 0, N = body.shapes.length; i < N; i++) {
                            ...
                            if ((!checkCollisionResponse || shape.collisionResponse) && (body.quaternion.mult(body.shapeOrientations[i], qi), body.quaternion.vmult(body.shapeOffsets[i], xi), xi.vadd(body.position, xi), this.intersectShape(shape, qi, xi, body), this.result.shouldStop))
                                break
                        }
                },
                ...
                _proto.intersectShape = function (shape, quat, position, body) {
                    if (!(function (from, direction, position) {
                            ...
                            return direction.scale(dot, intersect),
                ...
                _proto._intersectHeightfield = function (shape, quat, position, body, reportedShape) {
                    ...
                    iMaxX,
                    iMaxY,
                    index = intersectHeightfield_index;
                    iMinX = iMinY = 0,
                    ...
                    for (var i = iMinX; i < iMaxX; i++)
                        for (var j = iMinY; j < iMaxY; j++) {
                            ...
                            if (shape.getAabbAtIndex(i, j, aabb), aabb.overlapsRay(localRay)) {
                                if (shape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(position, quat, shape.pillarOffset, worldPillarOffset), this._intersectConvex(shape.pillarConvex, quat, worldPillarOffset, body, reportedShape, intersectConvexOptions), this.result.shouldStop)
                                    return;
                ...
                _proto._intersectSphere = function (sphere, quat, position, body, reportedShape) {
                    ...
                    if (!(delta < 0))
                        if (0 === delta)
                            from.lerp(to, delta, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1);
                        else {
                            var d1 = (-b - Math.sqrt(delta)) / (2 * a),
                            d2 = (-b + Math.sqrt(delta)) / (2 * a);
                            if (d1 >= 0 && d1 <= 1 && (from.lerp(to, d1, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1)), this.result.shouldStop)
                                return;
                ...
                _proto.reportIntersection = function (normal, hitPointWorld, shape, body, hitFaceIndex) {
                    ...
                    if (!(this.skipBackfaces && normal.dot(this.direction) > 0))
                        switch (result.hitFaceIndex = void 0 !== hitFaceIndex ? hitFaceIndex : -1, this.mode) {
                        case Ray.ALL:
                            this.hasHit = !0,
            ...
            intersectPoint = (new Vec3, new Vec3, new Vec3),
            a = new Vec3,
            b = new Vec3,
            c = new Vec3;
            new Vec3,
            ...
            var SAPBroadphase = function (_Broadphase) {
                function SAPBroadphase(world) {
                    var _this;
                    (_this = _Broadphase.call(this) || this).axisList = [],
                    _this.world = null,
                    _this.axisIndex = 0;
            ...
            SAPBroadphase.insertionSortX = function (a) {
                for (var i = 1, l = a.length; i < l; i++) {
                    var v = a[i],
                    j = void 0;
                    for (j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.x <= v.aabb.lowerBound.x); j--)
                        a[j + 1] = a[j];
                    a[j + 1] = v
                }
                return a
            ...
            SAPBroadphase.insertionSortY = function (a) {
                for (var i = 1, l = a.length; i < l; i++) {
                    var v = a[i],
                    j = void 0;
                    for (j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.y <= v.aabb.lowerBound.y); j--)
                        a[j + 1] = a[j];
                    a[j + 1] = v
                }
                return a
            ...
            SAPBroadphase.insertionSortZ = function (a) {
                for (var i = 1, l = a.length; i < l; i++) {
                    var v = a[i],
                    j = void 0;
                    for (j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.z <= v.aabb.lowerBound.z); j--)
                        a[j + 1] = a[j];
                    a[j + 1] = v
                }
                return a
            ...
            Utils.defaults = function (options, defaults) {
                for (var key in void 0 === options && (options = {}), defaults)
            ...
            Equation = function () {
                ...
                _proto.computeGiMGt = function () {
                    ...
                    return invIi.vmult(GA.rotational, tmp$1),
            ...
            ContactEquation = function (_Equation) {
                function ContactEquation(bodyA, bodyB, maxForce) {
                    var _this;
                    return void 0 === maxForce && (maxForce = 1e6),
                    (_this = _Equation.call(this, bodyA, bodyB, 0, maxForce) || this).restitution = 0,
                    _this.ri = new Vec3,
                    _this.rj = new Vec3,
                    _this.ni = new Vec3,
                    _this
            ...
            PointToPointConstraint = function (_Constraint) {
                function PointToPointConstraint(bodyA, pivotA, bodyB, pivotB, maxForce) {
                    var _this;
                    void 0 === pivotA && (pivotA = new Vec3),
                    void 0 === pivotB && (pivotB = new Vec3),
                    void 0 === maxForce && (maxForce = 1e6),
                    (_this = _Constraint.call(this, bodyA, bodyB) || this).pivotA = pivotA.clone(),
                    _this.pivotB = pivotB.clone();
                    var x = _this.equationX = new ContactEquation(bodyA, bodyB),
                    y = _this.equationY = new ContactEquation(bodyA, bodyB),
                    z = _this.equationZ = new ContactEquation(bodyA, bodyB);
                    return _this.equations.push(x, y, z),
                ...
                return _inheritsLoose(PointToPointConstraint, _Constraint),
            ...
            (Constraint),
            ConeEquation = function (_Equation) {
                function ConeEquation(bodyA, bodyB, options) {
                    ...
                    _this.angle = void 0 !== options.angle ? options.angle : 0,
                    _this
                }
                return _inheritsLoose(ConeEquation, _Equation),
            ...
            tmpVec1 = new Vec3,
            tmpVec2 = new Vec3,
            RotationalEquation = function (_Equation) {
                ...
                return _inheritsLoose(RotationalEquation, _Equation),
            ...
            tmpVec1$1 = new Vec3,
            tmpVec2$1 = new Vec3,
            ConeTwistConstraint = function (_PointToPointConstrai) {
                function ConeTwistConstraint(bodyA, bodyB, options) {
                    ...
                    t = _this.twistEquation = new RotationalEquation(bodyA, bodyB, options);
                ...
                return _inheritsLoose(ConeTwistConstraint, _PointToPointConstrai),
                ConeTwistConstraint.prototype.update = function () {
                    var bodyA = this.bodyA,
                    bodyB = this.bodyB,
                    cone = this.coneEquation,
                    twist = this.twistEquation;
                    _PointToPointConstrai.prototype.update.call(this),
            ...
            (PointToPointConstraint),
            DistanceConstraint = (new Vec3, new Vec3, function (_Constraint) {
                function DistanceConstraint(bodyA, bodyB, distance, maxForce) {
                    ...
                    return _this.equations.push(eq),
                    eq.minForce = -maxForce,
                    eq.maxForce = maxForce,
                    _this
                }
                return _inheritsLoose(DistanceConstraint, _Constraint),
                ...
                (Constraint)),
            LockConstraint = function (_PointToPointConstrai) {
                function LockConstraint(bodyA, bodyB, options) {
                    ...
                    r2 = _this.rotationalEquation2 = new RotationalEquation(bodyA, bodyB, options),
                    r3 = _this.rotationalEquation3 = new RotationalEquation(bodyA, bodyB, options);
                    return _this.equations.push(r1, r2, r3),
                    _this
                }
                return _inheritsLoose(LockConstraint, _PointToPointConstrai),
            ...
            (PointToPointConstraint),
            RotationalMotorEquation = (new Vec3, new Vec3, function (_Equation) {
                function RotationalMotorEquation(bodyA, bodyB, maxForce) {
                    var _this;
                    return void 0 === maxForce && (maxForce = 1e6),
                    (_this = _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) || this).axisA = new Vec3,
                    _this.axisB = new Vec3,
                    _this.targetVelocity = 0,
                    _this
                }
                return _inheritsLoose(RotationalMotorEquation, _Equation),
                ...
                (Equation)),
            HingeConstraint = function (_PointToPointConstrai) {
                function HingeConstraint(bodyA, bodyB, options) {
                    ...
                    rotational2 = _this.rotationalEquation2 = new RotationalEquation(bodyA, bodyB, options),
                    motor = _this.motorEquation = new RotationalMotorEquation(bodyA, bodyB, maxForce);
                    return motor.enabled = !1,
                ...
                _proto.update = function () {
                    ...
                    this.motorEquation.enabled && (bodyA.quaternion.vmult(this.axisA, motor.axisA), bodyB.quaternion.vmult(this.axisB, motor.axisB))
                },
                HingeConstraint
            }
            (PointToPointConstraint),
            HingeConstraint_update_tmpVec1 = new Vec3,
            HingeConstraint_update_tmpVec2 = new Vec3,
            FrictionEquation = function (_Equation) {
                ...
                return _inheritsLoose(FrictionEquation, _Equation),
            ...
            ContactMaterial = function ContactMaterial(m1, m2, options) {
                options = Utils.defaults(options, {
                    friction: .3,
                    restitution: .3,
            ...
            WheelInfo = function () {
                ...
                return WheelInfo.prototype.updateWheel = function (chassis) {
                    ...
                    if (this.isInContact) {
                        ...
                        raycastResult.suspensionLength = this.suspensionRestLength, this.suspensionRelativeVelocity = 0, raycastResult.directionWorld.scale(-1, raycastResult.hitNormalWorld), this.clippedInvContactDotSuspension = 1
                },
                WheelInfo
            }
            (),
            ...
            RaycastVehicle = function () {
                ...
                _proto.updateVehicle = function (timeStep) {
                    ...
                    for (var hitNormalWorldScaledWithProj = new Vec3, fwd = new Vec3, vel = new Vec3, _i3 = 0; _i3 < numWheels; _i3++) {
                        ...
                        _wheel.rotation += _wheel.deltaRotation,
                        _wheel.deltaRotation *= .99
                    }
                },
                _proto.updateSuspension = function (deltaTime) {
                    for (var chassisMass = this.chassisBody.mass, wheelInfos = this.wheelInfos, numWheels = wheelInfos.length, w_it = 0; w_it < numWheels; w_it++) {
                        ...
                        if (wheel.isInContact) {
                            var force = void 0,
                            length_diff = wheel.suspensionRestLength - wheel.suspensionLength;
                ...
                _proto.castRay = function (wheel) {
                    ...
                    if (wheel.raycastResult.groundObject = 0, object) {
                        ...
                        wheel.suspensionLength > maxSuspensionLength && (wheel.suspensionLength = maxSuspensionLength, wheel.raycastResult.reset());
                        var denominator = wheel.raycastResult.hitNormalWorld.dot(wheel.directionWorld),
                        chassis_velocity_at_contactPoint = new Vec3;
                        chassisBody.getVelocityAtWorldPoint(wheel.raycastResult.hitPointWorld, chassis_velocity_at_contactPoint);
                        var projVel = wheel.raycastResult.hitNormalWorld.dot(chassis_velocity_at_contactPoint);
                        if (denominator >=  - .1)
                            wheel.suspensionRelativeVelocity = 0, wheel.clippedInvContactDotSuspension = 10;
                        else {
                        ...
                        wheel.suspensionLength = wheel.suspensionRestLength + 0 * wheel.maxSuspensionTravel, wheel.suspensionRelativeVelocity = 0, wheel.directionWorld.scale(-1, wheel.raycastResult.hitNormalWorld), wheel.clippedInvContactDotSuspension = 1;
                    return depth
                },
                ...
                _proto.updateFriction = function (timeStep) {
                    ...
                    for (var _i4 = 0; _i4 < numWheels; _i4++) {
                        ...
                        _groundObject = _wheel2.raycastResult.body;
                        if (_groundObject) {
                            var axlei = axle[_i4];
                    ...
                    for (var _i5 = 0; _i5 < numWheels; _i5++) {
                        ...
                        _groundObject2 = _wheel3.raycastResult.body,
                        rollingFriction = 0;
                        ...
                        if (_wheel3.forwardImpulse = 0, _wheel3.skidInfo = 1, _groundObject2) {
                            ...
                            var x = .5 * _wheel3.forwardImpulse,
                            y = 1 * _wheel3.sideImpulse,
                    ...
                    if (this.sliding)
                        for (var _i6 = 0; _i6 < numWheels; _i6++) {
                            ...
                            0 !== _wheel4.sideImpulse && _wheel4.skidInfo < 1 && (_wheel4.forwardImpulse *= _wheel4.skidInfo, _wheel4.sideImpulse *= _wheel4.skidInfo)
                        }
                    for (var _i7 = 0; _i7 < numWheels; _i7++) {
                        var _wheel5 = wheelInfos[_i7],
                        rel_pos = new Vec3;
                        if (_wheel5.raycastResult.hitPointWorld.vsub(chassisBody.position, rel_pos), 0 !== _wheel5.forwardImpulse) {
                        ...
                        if (0 !== _wheel5.sideImpulse) {
                            ...
                            axle[_i7].scale(_wheel5.sideImpulse, sideImp),
            ...
            (),
            tmpVec4 = (new Vec3, new Vec3, new Vec3, new Vec3),
            tmpVec5 = new Vec3,
            tmpVec6 = new Vec3,
            castRay_rayvector = (new Ray, new Vec3, new Vec3),
            ...
            var Sphere = function (_Shape) {
                function Sphere(radius) {
                    ...
                    if ((_this = _Shape.call(this, {
                            ...
                            }) || this).radius = void 0 !== radius ? radius : 1, _this.radius < 0)
                        throw new Error("The sphere radius cannot be negative.");
                    return _this.updateBoundingSphereRadius(),
                    _this
                }
            ...
            (Shape),
            RigidVehicle = function () {
                function RigidVehicle(options) {
                    void 0 === options && (options = {}),
                    this.wheelBodies = [],
                    this.coordinateSystem = void 0 !== options.coordinateSystem ? options.coordinateSystem.clone() : new Vec3(1, 2, 3),
                ...
                return _proto.addWheel = function (options) {
                    var wheelBody;
                    void 0 === options && (options = {}),
                    wheelBody = options.body ? options.body : new Body({
                        mass: 1,
            ...
            SPHSystem = function () {
                ...
                _proto.getNeighbors = function (particle, neighbors) {
                    for (var N = this.particles.length, id = particle.id, R2 = this.smoothingRadius * this.smoothingRadius, dist = SPHSystem_getNeighbors_dist, i = 0; i !== N; i++) {
                        ...
                        id !== p.id && dist.lengthSquared() < R2 && neighbors.push(p)
                    }
                },
                _proto.update = function () {
                    ...
                    for (var a_pressure = SPHSystem_update_a_pressure, a_visc = SPHSystem_update_a_visc, gradW = SPHSystem_update_gradW, r_vec = SPHSystem_update_r_vec, u = SPHSystem_update_u, _i = 0; _i !== N; _i++) {
                        ...
                        for (var Pij = void 0, nabla = void 0, _neighbors = this.neighbors[_i], _numNeighbors = _neighbors.length, _j = 0; _j !== _numNeighbors; _j++) {
                            ...
                            u.scale(1 / (1e-4 + this.densities[_i] * this.densities[_j]) * this.viscosity * neighbor.mass, u),
                            nabla = this.nablaw(r),
                            u.scale(nabla, u),
            ...
            (),
            SPHSystem_getNeighbors_dist = new Vec3,
            ...
            Cylinder = function (_ConvexPolyhedron) {
                function Cylinder(radiusTop, radiusBottom, height, numSegments) {
                    ...
                    bottomface.push(0),
                    vertices.push(new Vec3(radiusTop * cos(0), radiusTop * sin(0), .5 * height)),
                    topface.push(1);
                    for (var i = 0; i < N; i++) {
                        var theta = 2 * Math.PI / N * (i + 1),
                        thetaN = 2 * Math.PI / N * (i + .5);
                        i < N - 1 ? (vertices.push(new Vec3(radiusBottom * cos(theta), radiusBottom * sin(theta), .5 * -height)), bottomface.push(2 * i + 2), vertices.push(new Vec3(radiusTop * cos(theta), radiusTop * sin(theta), .5 * height)), topface.push(2 * i + 3), faces.push([2 * i + 2, 2 * i + 3, 2 * i + 1, 2 * i])) : faces.push([0, 1, 2 * i + 1, 2 * i]),
                        (N % 2 == 1 || i < N / 2) && axes.push(new Vec3(cos(thetaN), sin(thetaN), 0))
                    }
                    faces.push(topface),
                    axes.push(new Vec3(0, 0, 1));
                    for (var temp = [], _i = 0; _i < bottomface.length; _i++)
                        temp.push(bottomface[bottomface.length - _i - 1]);
                    return faces.push(temp),
                    _ConvexPolyhedron.call(this, {
                        vertices: vertices,
                        faces: faces,
                        axes: axes
                    }) || this
                }
                return _inheritsLoose(Cylinder, _ConvexPolyhedron),
                Cylinder
            }
            (ConvexPolyhedron),
            Particle = function (_Shape) {
                function Particle() {
            ...
            (Shape),
            Plane = function (_Shape) {
                function Plane() {
                    var _this;
                    return (_this = _Shape.call(this, {
                            type: Shape.types.PLANE
                        }) || this).worldNormal = new Vec3,
                    _this.worldNormalNeedsUpdate = !0,
            ...
            Heightfield = function (_Shape) {
                function Heightfield(data, options) {
                    ...
                    null === options.minValue && _this.updateMinValue(),
                    null === options.maxValue && _this.updateMaxValue(),
                    _this.cacheEnabled = !0,
                ...
                _proto.setHeightValueAtIndex = function (xi, yi, value) {
                    ...
                    xi > 0 && (this.clearCachedConvexTrianglePillar(xi - 1, yi, !0), this.clearCachedConvexTrianglePillar(xi - 1, yi, !1)),
                    yi > 0 && (this.clearCachedConvexTrianglePillar(xi, yi - 1, !0), this.clearCachedConvexTrianglePillar(xi, yi - 1, !1)),
                ...
                _proto.getIndexOfPosition = function (x, y, result, clamp) {
                    ...
                    return result[0] = xi,
                    result[1] = yi,
                    clamp && (xi < 0 && (xi = 0), yi < 0 && (yi = 0), xi >= data.length - 1 && (xi = data.length - 1), yi >= data[0].length - 1 && (yi = data[0].length - 1)),
                ...
                _proto.getConvexTrianglePillar = function (xi, yi, getUpperTriangle) {
                    ...
                    if (this.cacheEnabled) {
                        ...
                        if (_data)
                            return this.pillarConvex = _data.convex, void(this.pillarOffset = _data.offset);
            ...
            var Octree = function (_OctreeNode) {
                ...
                return _inheritsLoose(Octree, _OctreeNode),
                Octree
            }
            (function () {
                ...
                _proto.removeEmptyNodes = function () {
                    for (var i = this.children.length - 1; i >= 0; i--)
                        this.children[i].removeEmptyNodes(), this.children[i].children.length || this.children[i].data.length || this.children.splice(i, 1)
                },
                OctreeNode
            }
                ()),
            halfDiagonal = new Vec3,
            tmpAABB$1 = new AABB,
            Trimesh = function (_Shape) {
                ...
                _proto.computeLocalAABB = function (aabb) {
                    ...
                    u.copy(v);
                    for (var i = 0; i !== n; i++)
                        this.getVertex(i, v), v.x < l.x ? l.x = v.x : v.x > u.x && (u.x = v.x), v.y < l.y ? l.y = v.y : v.y > u.y && (u.y = v.y), v.z < l.z ? l.z = v.z : v.z > u.z && (u.z = v.z)
                },
            ...
            Trimesh.createTorus = function (radius, tube, radialSegments, tubularSegments, arc) {
                ...
                void 0 === tube && (tube = .5),
                void 0 === radialSegments && (radialSegments = 8),
                void 0 === tubularSegments && (tubularSegments = 6),
                void 0 === arc && (arc = 2 * Math.PI);
                ...
                for (var _j = 1; _j <= radialSegments; _j++)
                    for (var _i2 = 1; _i2 <= tubularSegments; _i2++) {
                        ...
                        b = (tubularSegments + 1) * (_j - 1) + _i2 - 1,
                        c = (tubularSegments + 1) * (_j - 1) + _i2,
                        d = (tubularSegments + 1) * _j + _i2;
                        indices.push(a, b, d),
                        indices.push(b, c, d)
                    }
            ...
            GSSolver = function (_Solver) {
                function GSSolver() {
                    var _this;
                    return (_this = _Solver.call(this) || this).iterations = 10,
                    _this.tolerance = 1e-7,
                    _this
                }
                return _inheritsLoose(GSSolver, _Solver),
                    ...
                    if (0 !== Neq) {
                        ...
                        for (iter = 0; iter !== maxIter; iter++) {
                            ...
                            for (var j = 0; j !== Neq; j++) {
                                ...
                                B = Bs[j],
                                invC = invCs[j],
                                (lambdaj = lambda[j]) + (deltalambda = invC * (B - _c.computeGWlambda() - _c.eps * lambdaj)) < _c.minForce ? deltalambda = _c.minForce - lambdaj : lambdaj + deltalambda > _c.maxForce && (deltalambda = _c.maxForce - lambdaj),
            ...
            GSSolver_solve_Bs = [],
            SplitSolver = function (_Solver) {
                function SplitSolver(subsolver) {
                    var _this;
                    for ((_this = _Solver.call(this) || this).iterations = 10, _this.tolerance = 1e-7, _this.subsolver = subsolver, _this.nodes = [], _this.nodePool = []; _this.nodePool.length < 128; )
                ...
                _proto.solve = function (dt, world) {
                    for (var child, nodes = SplitSolver_solve_nodes, nodePool = this.nodePool, bodies = world.bodies, equations = this.equations, Neq = equations.length, Nbodies = bodies.length, subsolver = this.subsolver; nodePool.length < Nbodies; )
            ...
            function bfs(root, visitFunc, bds, eqs) {
                for (queue.push(root), root.visited = !0, visitFunc(root, bds, eqs); queue.length; )
                    for (var _node3 = queue.pop(), child = void 0; child = getUnvisitedNode(_node3.children); )
            ...
            Vec3Pool = function (_Pool) {
                function Vec3Pool() {
                    var _this;
                    return (_this = _Pool.call(this) || this).type = Vec3,
                    _this
                }
                return _inheritsLoose(Vec3Pool, _Pool),
            ...
            Narrowphase = function () {
                ...
                _proto.createFrictionFromAverage = function (numContacts) {
                    ...
                    if (this.createFrictionEquationsFromContact(c, this.frictionResult) && 1 !== numContacts) {
                        ...
                        for (var bodyA = c.bi, i = (c.bj, 0); i !== numContacts; i++)
                            (c = this.result[this.result.length - 1 - i]).bi !== bodyA ? (averageNormal.vadd(c.ni, averageNormal), averageContactPointA.vadd(c.ri, averageContactPointA), averageContactPointB.vadd(c.rj, averageContactPointB)) : (averageNormal.vsub(c.ni, averageNormal), averageContactPointA.vadd(c.rj, averageContactPointA), averageContactPointB.vadd(c.ri, averageContactPointB));
                ...
                _proto.spherePlane = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
                    var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                    if (r.ni.set(0, 0, 1), qj.vmult(r.ni, r.ni), r.ni.negate(r.ni), r.ni.normalize(), r.ni.scale(si.radius, r.ri), xi.vsub(xj, point_on_plane_to_sphere), r.ni.scale(r.ni.dot(point_on_plane_to_sphere), plane_to_sphere_ortho), point_on_plane_to_sphere.vsub(plane_to_sphere_ortho, r.rj), -point_on_plane_to_sphere.dot(r.ni) <= si.radius) {
                        if (justTest)
                            return !0;
                        var ri = r.ri,
                        rj = r.rj;
                ...
                _proto.sphereBox = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
                    ...
                    for (var R = si.radius, found = !1, side_ns = sphereBox_side_ns, side_ns1 = sphereBox_side_ns1, side_ns2 = sphereBox_side_ns2, side_h = null, side_penetrations = 0, side_dot1 = 0, side_dot2 = 0, side_distance = null, idx = 0, nsides = sides.length; idx !== nsides && !1 === found; idx++) {
                        ...
                        if (dot < h + R && dot > 0) {
                            ...
                            if (dot1 < h1 && dot1 > -h1 && dot2 < h2 && dot2 > -h2) {
                                ...
                                if ((null === side_distance || _dist < side_distance) && (side_distance = _dist, side_dot1 = dot1, side_dot2 = dot2, side_h = h, side_ns.copy(ns), side_ns1.copy(ns1), side_ns2.copy(ns2), side_penetrations++, justTest))
                                    return !0
                            }
                        }
                    }
                    ...
                    for (var rj = v3pool.get(), sphere_to_corner = sphereBox_sphere_to_corner, j = 0; 2 !== j && !found; j++)
                        for (var k = 0; 2 !== k && !found; k++)
                            for (var l = 0; 2 !== l && !found; l++)
                                if (rj.set(0, 0, 0), j ? rj.vadd(sides[0], rj) : rj.vsub(sides[0], rj), k ? rj.vadd(sides[1], rj) : rj.vsub(sides[1], rj), l ? rj.vadd(sides[2], rj) : rj.vsub(sides[2], rj), xj.vadd(rj, sphere_to_corner), sphere_to_corner.vsub(xi, sphere_to_corner), sphere_to_corner.lengthSquared() < R * R) {
                                    if (justTest)
                                        return !0;
                                    found = !0;
                    ...
                    v3pool.release(rj),
                    rj = null;
                    for (var edgeTangent = v3pool.get(), edgeCenter = v3pool.get(), r = v3pool.get(), orthogonal = v3pool.get(), dist = v3pool.get(), Nsides = sides.length, _j = 0; _j !== Nsides && !found; _j++)
                ...
                _proto.sphereConvex = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
                    ...
                    for (var normals = sj.faceNormals, faces = sj.faces, verts = sj.vertices, R = si.radius, found = !1, i = 0; i !== verts.length; i++) {
                        ...
                        if (worldCorner.vsub(xi, sphere_to_corner), sphere_to_corner.lengthSquared() < R * R) {
                            ...
                            found = !0;
                            var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                            return r.ri.copy(sphere_to_corner),
                            r.ri.normalize(),
                            r.ni.copy(r.ri),
                            r.ri.scale(R, r.ri),
                    ...
                    for (var _i = 0, nfaces = faces.length; _i !== nfaces && !1 === found; _i++) {
                        ...
                        if (xi.vsub(worldPoint, worldPointToSphere), penetration < 0 && worldPointToSphere.dot(worldNormal) > 0) {
                            ...
                            if (pointInPolygon(faceVerts, worldNormal, xi)) {
                                ...
                                worldNormal.scale(-R, _r3.ri),
                                worldNormal.negate(_r3.ni);
                                ...
                                _r3.rj.vadd(penetrationVec2, _r3.rj),
                                _r3.rj.vadd(xj, _r3.rj),
                                _r3.rj.vsub(bj.position, _r3.rj),
                                _r3.ri.vadd(xi, _r3.ri),
                                _r3.ri.vsub(bi.position, _r3.ri),
                                v3pool.release(penetrationVec2),
                                v3pool.release(penetrationSpherePoint),
                                this.result.push(_r3),
                                this.createFrictionEquationsFromContact(_r3, this.frictionResult);
                            ...
                            for (var _j3 = 0; _j3 !== face.length; _j3++) {
                                ...
                                if (p.vsub(xi, xi_to_p), dot > 0 && dot * dot < edge.lengthSquared() && xi_to_p.lengthSquared() < R * R) {
                                    ...
                                    p.vsub(xi, _r4.ni),
                                    _r4.ni.normalize(),
                                    _r4.ni.scale(R, _r4.ri),
                                    _r4.rj.vadd(xj, _r4.rj),
                                    _r4.rj.vsub(bj.position, _r4.rj),
                    ...
                    if (!(iMaxX < 0 || iMaxY < 0 || iMinX > data.length || iMinY > data[0].length)) {
                        ...
                        if (!(localConvexPos.z - radius > max || localConvexPos.z + radius < min))
                            for (var i = iMinX; i < iMaxX; i++)
                                for (var j = iMinY; j < iMaxY; j++) {
                                    var intersecting = !1;
                                    if (hfShape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset), convexPos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + convexShape.boundingSphereRadius && (intersecting = this.convexConvex(convexShape, hfShape.pillarConvex, convexPos, worldPillarOffset, convexQuat, hfQuat, convexBody, hfBody, null, null, justTest, faceList, null)), justTest && intersecting)
                                        return !0;
                                    if (hfShape.getConvexTrianglePillar(i, j, !0), Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset), convexPos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + convexShape.boundingSphereRadius && (intersecting = this.convexConvex(convexShape, hfShape.pillarConvex, convexPos, worldPillarOffset, convexQuat, hfQuat, convexBody, hfBody, null, null, justTest, faceList, null)), justTest && intersecting)
                                        return !0
                                }
                    }
                },
                ...
                _proto.sphereTrimesh = function (sphereShape, trimeshShape, spherePos, trimeshPos, sphereQuat, trimeshQuat, sphereBody, trimeshBody, rsi, rsj, justTest) {
                    ...
                    for (var v = sphereTrimesh_v, radiusSquared = sphereShape.radius * sphereShape.radius, i = 0; i < triangles.length; i++)
                        for (var j = 0; j < 3; j++)
                            if (trimeshShape.getVertex(trimeshShape.indices[3 * triangles[i] + j], v), v.vsub(localSpherePos, relpos), relpos.lengthSquared() <= radiusSquared) {
                                if (v2.copy(v), Transform.pointToWorldFrame(trimeshPos, trimeshQuat, v2, v), v.vsub(spherePos, relpos), justTest)
                                    return !0;
                    ...
                    for (var _i2 = 0; _i2 < triangles.length; _i2++)
                        for (var _j6 = 0; _j6 < 3; _j6++) {
                            ...
                            if (positionAlongEdgeA > 0 && positionAlongEdgeB < 0)
                                if (localSpherePos.vsub(edgeVertexA, tmp), edgeVectorUnit.copy(edgeVector), edgeVectorUnit.normalize(), positionAlongEdgeA = tmp.dot(edgeVectorUnit), edgeVectorUnit.scale(positionAlongEdgeA, tmp), tmp.vadd(edgeVertexA, tmp), tmp.distanceTo(localSpherePos) < sphereShape.radius) {
                                    if (justTest)
                                        return !0;
                    ...
                    for (var va = sphereTrimesh_va, vb = sphereTrimesh_vb, vc = sphereTrimesh_vc, normal = sphereTrimesh_normal, _i3 = 0, N = triangles.length; _i3 !== N; _i3++) {
                        ...
                        if (normal.scale(_dist2, tmp), localSpherePos.vsub(tmp, tmp), _dist2 = tmp.distanceTo(localSpherePos), Ray.pointInTriangle(tmp, va, vb, vc) && _dist2 < sphereShape.radius) {
                            if (justTest)
                                return !0;
            ...
            World = function (_EventTarget) {
                function World(options) {
                    var _this;
                    return void 0 === options && (options = {}),
                    (_this = _EventTarget.call(this) || this).dt = -1,
                    ...
                    options.gravity && _this.gravity.copy(options.gravity),
                    _this.broadphase = void 0 !== options.broadphase ? options.broadphase : new NaiveBroadphase,
                    _this.bodies = [],
                    _this.hasActiveBodies = !1,
                    _this.solver = void 0 !== options.solver ? options.solver : new GSSolver,
                    _this.constraints = [],
                ...
                _proto.step = function (dt, timeSinceLastCalled, maxSubSteps) {
                    if (void 0 === timeSinceLastCalled && (timeSinceLastCalled = 0), void 0 === maxSubSteps && (maxSubSteps = 10), 0 === timeSinceLastCalled)
                        this.internalStep(dt), this.time += dt;
                    else {
                        this.accumulator += timeSinceLastCalled;
                        for (var substeps = 0; this.accumulator >= dt && substeps < maxSubSteps; )
                            this.internalStep(dt), this.accumulator -= dt, substeps++;
                ...
                _proto.internalStep = function (dt) {
                    ...
                    for (i = 0; i !== Nconstraints; i++) {
                        ...
                        if (!c.collideConnected)
                            for (var j = p1.length - 1; j >= 0; j -= 1)
                                (c.bodyA === p1[j] && c.bodyB === p2[j] || c.bodyB === p1[j] && c.bodyA === p2[j]) && (p1.splice(j, 1), p2.splice(j, 1))
                    }
                    ...
                    for (this.frictionEquations.length = 0, this.narrowphase.getContacts(p1, p2, this, contacts, oldcontacts, this.frictionEquations, frictionEquationPool), doProfiling && (profile.narrowphase = performance.now() - profilingStart), doProfiling && (profilingStart = performance.now()), i = 0; i < this.frictionEquations.length; i++)
                    ...
                    for (var ncontacts = contacts.length, k = 0; k !== ncontacts; k++) {
                        ...
                        if (_bi.material && bj.material && (_bi.material.friction >= 0 && bj.material.friction >= 0 && _bi.material.friction * bj.material.friction, _bi.material.restitution >= 0 && bj.material.restitution >= 0 && (_c.restitution = _bi.material.restitution * bj.material.restitution)), solver.addEquation(_c), _bi.allowSleep && _bi.type === Body.DYNAMIC && _bi.sleepState === Body.SLEEPING && bj.sleepState === Body.AWAKE && bj.type !== Body.STATIC)
                            bj.velocity.lengthSquared() + bj.angularVelocity.lengthSquared() >= 2 * Math.pow(bj.sleepSpeedLimit, 2) && (_bi.wakeUpAfterNarrowphase = !0);
                        if (bj.allowSleep && bj.type === Body.DYNAMIC && bj.sleepState === Body.SLEEPING && _bi.sleepState === Body.AWAKE && _bi.type !== Body.STATIC)
                            _bi.velocity.lengthSquared() + _bi.angularVelocity.lengthSquared() >= 2 * Math.pow(_bi.sleepSpeedLimit, 2) && (bj.wakeUpAfterNarrowphase = !0);
                        this.collisionMatrix.set(_bi, bj, !0),
                        this.collisionMatrixPrevious.get(_bi, bj) || (World_step_collideEvent.body = bj, World_step_collideEvent.contact = _c, _bi.dispatchEvent(World_step_collideEvent), World_step_collideEvent.body = _bi, bj.dispatchEvent(World_step_collideEvent)),
                    ...
                    for (i = 0; i !== N; i++) {
                        ...
                        if (_bi3.type & DYNAMIC) {
                            var ld = pow(1 - _bi3.linearDamping, dt),
                            v = _bi3.velocity;
                            v.scale(ld, v);
                    ...
                    for (this.clearForces(), this.broadphase.dirty = !0, doProfiling && (profile.integrate = performance.now() - profilingStart), this.time += dt, this.stepnumber += 1, this.dispatchEvent(World_step_postStepEvent), i = 0; i !== N; i++) {
                        var _bi5 = bodies[i],
                        postStep = _bi5.postStep;
                        postStep && postStep.call(_bi5)
                    }
                    var hasActiveBodies = !0;
                    if (this.allowSleep)
                        for (hasActiveBodies = !1, i = 0; i !== N; i++) {
                            var _bi6 = bodies[i];
                            _bi6.sleepTick(this.time),
                            _bi6.sleepState !== Body.SLEEPING && (hasActiveBodies = !0)
                        }
            ...
            World.prototype.emitContactEvents = (additions = [], removals = [], beginContactEvent = {
                ...
                if ((hasBeginContact || hasEndContact) && this.bodyOverlapKeeper.getDiff(additions, removals), hasBeginContact) {
                    for (var i = 0, l = additions.length; i < l; i += 2)
                        beginContactEvent.bodyA = this.getBodyById(additions[i]), beginContactEvent.bodyB = this.getBodyById(additions[i + 1]), this.dispatchEvent(beginContactEvent);
                    beginContactEvent.bodyA = beginContactEvent.bodyB = null
                }
                if (hasEndContact) {
                    for (var _i2 = 0, _l = removals.length; _i2 < _l; _i2 += 2)
                        endContactEvent.bodyA = this.getBodyById(removals[_i2]), endContactEvent.bodyB = this.getBodyById(removals[_i2 + 1]), this.dispatchEvent(endContactEvent);
                ...
                if ((hasBeginShapeContact || hasEndShapeContact) && this.shapeOverlapKeeper.getDiff(additions, removals), hasBeginShapeContact) {
                    for (var _i3 = 0, _l2 = additions.length; _i3 < _l2; _i3 += 2) {
                        ...
                        shapeB = this.getShapeById(additions[_i3 + 1]);
                ...
                if (hasEndShapeContact) {
                    for (var _i4 = 0, _l3 = removals.length; _i4 < _l3; _i4 += 2) {
                        ...
                        _shapeB = this.getShapeById(removals[_i4 + 1]);
    ...
    6: [function (require, module, exports) {
            ...
            function _setOptions(options) {
                ...
                options.margin = options.hasOwnProperty("margin") ? options.margin : .01,
            ...
            exports.createBoxShape = function (root, options) {
                ...
                _setOptions(options),
                options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root, options), options.minHalfExtent, options.maxHalfExtent));
                ...
                return Ammo.destroy(btHalfExtents),
            ...
            exports.createSphereShape = function (root, options) {
                ...
                _setOptions(options),
                radius = options.fit !== FIT.MANUAL || isNaN(options.sphereRadius) ? _computeRadius(root, options, _computeBounds(root, options)) : options.sphereRadius;
            ...
            exports.createHullShape = function () {
                ...
                return function (root, options) {
                    if (options.type = TYPE.HULL, _setOptions(options), options.fit === FIT.MANUAL)
                    ...
                    center.addVectors(bounds.max, bounds.min).multiplyScalar(.5);
                    let vertexCount = 0;
                    ...
                    _iterateGeometries(root, options, (geo, transform) => {
                        ...
                        for (let i = 0; i < components.length; i += 3)
                            Math.random() <= p && (vertex.set(components[i], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), btVertex.setValue(vertex.x, vertex.y, vertex.z), originalHull.addPoint(btVertex, i === components.length - 3))
                    });
            ...
            exports.createHACDShapes = function () {
                ...
                center = new THREE.Vector3;
                return function (root, options) {
                    if (options.type = TYPE.HACD, _setOptions(options), options.fit === FIT.MANUAL)
                        return console.warn("cannot use fit: manual with type: hacd"), [];
                    if (!Ammo.hasOwnProperty("HACD"))
                        return console.warn("HACD unavailable in included build of Ammo.js. Visit https://github.com/mozillareality/ammo.js for the latest version."), [];
                    ...
                    _iterateGeometries(root, options, geo => {
                        vertexCount += geo.attributes.position.array.length / 3,
                        geo.index ? triCount += geo.index.array.length / 3 : triCount += geo.attributes.position.array.length / 9
                    });
                    ...
                    _iterateGeometries(root, options, (geo, transform) => {
                        ...
                        for (let i = 0; i < components.length; i += 3)
                            v.set(components[i + 0], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), Ammo.HEAPF64[pptr + i + 0] = v.x, Ammo.HEAPF64[pptr + i + 1] = v.y, Ammo.HEAPF64[pptr + i + 2] = v.z;
                        if (indices)
            ...
            exports.createVHACDShapes = function () {
                ...
                center = new THREE.Vector3;
                return function (root, options) {
                    if (options.type = TYPE.VHACD, _setOptions(options), options.fit === FIT.MANUAL)
                        return console.warn("cannot use fit: manual with type: vhacd"), [];
                    if (!Ammo.hasOwnProperty("VHACD"))
                        return console.warn("VHACD unavailable in included build of Ammo.js. Visit https://github.com/mozillareality/ammo.js for the latest version."), [];
                    const bounds = _computeBounds(root, options),
                    scale = _computeScale(root, options);
                    let vertexCount = 0,
                    triCount = 0;
                    ...
                    _iterateGeometries(root, options, geo => {
                        ...
                        geo.index ? triCount += geo.index.count / 3 : triCount += geo.attributes.position.count / 3
                    });
                    ...
                    _iterateGeometries(root, options, (geo, transform) => {
                        ...
                        indices = geo.index ? geo.index.array : null;
                        for (let i = 0; i < components.length; i += 3)
                            v.set(components[i + 0], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), Ammo.HEAPF64[pptr + 0] = v.x, Ammo.HEAPF64[pptr + 1] = v.y, Ammo.HEAPF64[pptr + 2] = v.z, pptr += 3;
                        if (indices)
                            for (let i = 0; i < indices.length; i++)
                                Ammo.HEAP32[tptr] = indices[i], tptr++;
                        else
                            for (let i = 0; i < components.length / 3; i++)
                                Ammo.HEAP32[tptr] = i, tptr++
                    }),
            ...
            exports.createTriMeshShape = function () {
                ...
                return function (root, options) {
                    if (options.type = TYPE.MESH, _setOptions(options), options.fit === FIT.MANUAL)
                    ...
                    _iterateGeometries(root, options, (geo, transform) => {
                        ...
                        if (geo.index)
                            for (let i = 0; i < geo.index.count; i += 3) {
                                ...
                                triMesh.addTriangle(bta, btb, btc, !1)
                            }
                        else
                    ...
                    return collisionShape.resources = [triMesh],
                    Ammo.destroy(bta),
                    Ammo.destroy(btb),
                    Ammo.destroy(btc),
            ...
            exports.createHeightfieldTerrainShape = function (root, options) {
                if (_setOptions(options), options.fit === FIT.ALL)
                    return console.warn("cannot use fit: all with type: heightfield"), null;
                const heightfieldDistance = options.heightfieldDistance || 1,
                heightfieldData = options.heightfieldData || [],
                heightScale = options.heightScale || 0,
                upAxis = options.hasOwnProperty("upAxis") ? options.upAxis : 1,
                hdt = (() => {
                ...
                flipQuadEdges = !options.hasOwnProperty("flipQuadEdges") || options.flipQuadEdges,
                heightStickLength = heightfieldData.length,
                heightStickWidth = heightStickLength > 0 ? heightfieldData[0].length : 0,
                data = Ammo._malloc(heightStickLength * heightStickWidth * 4),
                ptr = data / 4;
                ...
                scale = new Ammo.btVector3(heightfieldDistance, 1, heightfieldDistance);
                return collisionShape.setLocalScaling(scale),
                Ammo.destroy(scale),
            ...
            _iterateGeometries = function () {
                ...
                return function (root, options, cb) {
                    ...
                    root.traverse(mesh => {
                        !mesh.isMesh || THREE.Sky && mesh.__proto__ == THREE.Sky.prototype || !(options.includeInvisible || mesh.el && mesh.el.object3D.visible || mesh.visible) || (mesh === root ? transform.identity() : (hasUpdateMatricesFunction && mesh.updateMatrices(), transform.multiplyMatrices(inverse, mesh.matrixWorld)), cb(mesh.geometry.isBufferGeometry ? mesh.geometry : bufferGeometry.fromGeometry(mesh.geometry), transform))
                    })
                }
            }
            (),
            ...
            _computeBounds = function () {
                ...
                return function (root, options) {
                    ...
                    maxY = -1 / 0,
                    maxZ = -1 / 0;
                    return bounds.min.set(0, 0, 0),
                    bounds.max.set(0, 0, 0),
                    _iterateGeometries(root, options, (geo, transform) => {
                        const components = geo.attributes.position.array;
                        for (let i = 0; i < components.length; i += 3)
                            v.set(components[i], components[i + 1], components[i + 2]).applyMatrix4(transform), v.x < minX && (minX = v.x), v.y < minY && (minY = v.y), v.z < minZ && (minZ = v.z), v.x > maxX && (maxX = v.x), v.y > maxY && (maxY = v.y), v.z > maxZ && (maxZ = v.z)
                    }),
    ...
    7: [function (require, module, exports) {
            (function (global) {
                ...
                three = "undefined" != typeof window ? window.THREE : void 0 !== global ? global.THREE : null,
                ConvexHull = function () {
                    var line3,
                    plane,
                    closestPoint,
                    ...
                    return Object.assign(ConvexHull.prototype, {
                        setFromPoints: function (points) {
                            !0 !== Array.isArray(points) && console.error("THREE.ConvexHull: Points parameter is not an array."),
                            points.length < 4 && console.error("THREE.ConvexHull: The algorithm needs at least four points."),
                            this.makeEmpty();
                        ...
                        setFromObject: function (object) {
                            ...
                            object.traverse(function (node) {
                                ...
                                if (void 0 !== geometry && (geometry.isGeometry && (geometry = geometry.toBufferGeometry ? geometry.toBufferGeometry() : (new three.BufferGeometry).fromGeometry(geometry)), geometry.isBufferGeometry)) {
                                    var attribute = geometry.attributes.position;
                                    if (void 0 !== attribute)
                                        for (i = 0, l = attribute.count; i < l; i++)
                                            (point = new three.Vector3).fromBufferAttribute(attribute, i).applyMatrix4(node.matrixWorld), points.push(point)
                                }
                            }),
                            this.setFromPoints(points)
                        },
                        containsPoint: function (point) {
                            for (var faces = this.faces, i = 0, l = faces.length; i < l; i++) {
                                if (faces[i].distanceToPoint(point) > this.tolerance)
                                    return !1
                            }
                            return !0
                        },
                        intersectRay: function (ray, target) {
                            for (var faces = this.faces, tNear = -1 / 0, tFar = 1 / 0, i = 0, l = faces.length; i < l; i++) {
                                var face = faces[i],
                                vN = face.distanceToPoint(ray.origin),
                                vD = face.normal.dot(ray.direction);
                                if (vN > 0 && vD >= 0)
                                    return null;
                                var t = 0 !== vD ? -vN / vD : 0;
                            ...
                            return tNear !== -1 / 0 ? ray.at(tNear, target) : ray.at(tFar, target),
                            target
                        },
                        intersectsRay: function (ray) {
                            return null !== this.intersectRay(ray, v1)
                        },
                        makeEmpty: function () {
                            return this.faces = [],
                            this.vertices = [],
                        ...
                        addVertexToFace: function (vertex, face) {
                            return vertex.face = face,
                            null === face.outside ? this.assigned.append(vertex) : this.assigned.insertBefore(face.outside, vertex),
                            face.outside = vertex,
                            this
                        },
                        removeVertexFromFace: function (vertex, face) {
                            return vertex === face.outside && (null !== vertex.next && vertex.next.face === face ? face.outside = vertex.next : face.outside = null),
                            this.assigned.remove(vertex),
                            this
                        },
                        removeAllVerticesFromFace: function (face) {
                            if (null !== face.outside) {
                                for (var start = face.outside, end = face.outside; null !== end.next && end.next.face === face; )
                                    end = end.next;
                                return this.assigned.removeSubList(start, end),
                        ...
                        deleteFaceVertices: function (face, absorbingFace) {
                            ...
                            if (void 0 !== faceVertices)
                                if (void 0 === absorbingFace)
                                    this.unassigned.appendChain(faceVertices);
                                else {
                                    var vertex = faceVertices;
                                    do {
                                        var nextVertex = vertex.next;
                                        absorbingFace.distanceToPoint(vertex.point) > this.tolerance ? this.addVertexToFace(vertex, absorbingFace) : this.unassigned.append(vertex),
                                        vertex = nextVertex
                                    } while (null !== vertex)
                                }
                            return this
                        ...
                        resolveUnassignedPoints: function (newFaces) {
                            if (!1 === this.unassigned.isEmpty()) {
                                ...
                                do {
                                    for (var nextVertex = vertex.next, maxDistance = this.tolerance, maxFace = null, i = 0; i < newFaces.length; i++) {
                                        var face = newFaces[i];
                                        if (face.mark === Visible) {
                                            var distance = face.distanceToPoint(vertex.point);
                                            if (distance > maxDistance && (maxDistance = distance, maxFace = face), maxDistance > 1e3 * this.tolerance)
                                                break
                                        }
                                    }
                                    null !== maxFace && this.addVertexToFace(vertex, maxFace),
                                    vertex = nextVertex
                                } while (null !== vertex)
                            }
                            return this
                        ...
                        computeExtremes: function () {
                            ...
                            for (min.copy(this.vertices[0].point), max.copy(this.vertices[0].point), i = 0, l = this.vertices.length; i < l; i++) {
                            ...
                            return this.tolerance = 3 * Number.EPSILON * (Math.max(Math.abs(min.x), Math.abs(max.x)) + Math.max(Math.abs(min.y), Math.abs(max.y)) + Math.max(Math.abs(min.z), Math.abs(max.z))), {
                                min: minVertices,
                                max: maxVertices
                            }
                        },
                        computeInitialHull: function () {
                            void 0 === line3 && (line3 = new three.Line3, plane = new three.Plane, closestPoint = new three.Vector3);
                            var vertex,
                            v0,
                            v1,
                            v2,
                            ...
                            distance,
                            vertices = this.vertices,
                            extremes = this.computeExtremes(),
                            min = extremes.min,
                            max = extremes.max,
                            maxDistance = 0,
                            index = 0;
                            for (i = 0; i < 3; i++)
                                (distance = max[i].point.getComponent(i) - min[i].point.getComponent(i)) > maxDistance && (maxDistance = distance, index = i);
                            for (v0 = min[index], v1 = max[index], maxDistance = 0, line3.set(v0.point, v1.point), i = 0, l = this.vertices.length; i < l; i++)
                                (vertex = vertices[i]) !== v0 && vertex !== v1 && (line3.closestPointToPoint(vertex.point, !0, closestPoint), (distance = closestPoint.distanceToSquared(vertex.point)) > maxDistance && (maxDistance = distance, v2 = vertex));
                            for (maxDistance = -1, plane.setFromCoplanarPoints(v0.point, v1.point, v2.point), i = 0, l = this.vertices.length; i < l; i++)
                                (vertex = vertices[i]) !== v0 && vertex !== v1 && vertex !== v2 && (distance = Math.abs(plane.distanceToPoint(vertex.point))) > maxDistance && (maxDistance = distance, v3 = vertex);
                            var faces = [];
                            if (plane.distanceToPoint(v3.point) < 0)
                                for (faces.push(Face.create(v0, v1, v2), Face.create(v3, v1, v0), Face.create(v3, v2, v1), Face.create(v3, v0, v2)), i = 0; i < 3; i++)
                                    j = (i + 1) % 3, faces[i + 1].getEdge(2).setTwin(faces[0].getEdge(j)), faces[i + 1].getEdge(1).setTwin(faces[j + 1].getEdge(0));
                            else
                                for (faces.push(Face.create(v0, v2, v1), Face.create(v3, v0, v1), Face.create(v3, v1, v2), Face.create(v3, v2, v0)), i = 0; i < 3; i++)
                                    j = (i + 1) % 3, faces[i + 1].getEdge(2).setTwin(faces[0].getEdge((3 - i) % 3)), faces[i + 1].getEdge(0).setTwin(faces[j + 1].getEdge(1));
                            for (i = 0; i < 4; i++)
                                this.faces.push(faces[i]);
                            for (i = 0, l = vertices.length; i < l; i++)
                                if ((vertex = vertices[i]) !== v0 && vertex !== v1 && vertex !== v2 && vertex !== v3) {
                                    maxDistance = this.tolerance;
                                    var maxFace = null;
                                    for (j = 0; j < 4; j++)
                                        (distance = this.faces[j].distanceToPoint(vertex.point)) > maxDistance && (maxDistance = distance, maxFace = this.faces[j]);
                                    null !== maxFace && this.addVertexToFace(vertex, maxFace)
                                }
                            return this
                        },
                        reindexFaces: function () {
                            for (var activeFaces = [], i = 0; i < this.faces.length; i++) {
                                var face = this.faces[i];
                                face.mark === Visible && activeFaces.push(face)
                            }
                            return this.faces = activeFaces,
                            this
                        },
                        nextVertexToAdd: function () {
                            if (!1 === this.assigned.isEmpty()) {
                                var eyeVertex,
                                maxDistance = 0,
                                eyeFace = this.assigned.first().face,
                                vertex = eyeFace.outside;
                                do {
                                    var distance = eyeFace.distanceToPoint(vertex.point);
                                    distance > maxDistance && (maxDistance = distance, eyeVertex = vertex),
                                    vertex = vertex.next
                                } while (null !== vertex && vertex.face === eyeFace);
                                return eyeVertex
                            }
                        },
                        computeHorizon: function (eyePoint, crossEdge, face, horizon) {
                            ...
                            face.mark = 1,
                            edge = null === crossEdge ? crossEdge = face.getEdge(0) : crossEdge.next;
                            do {
                                var twinEdge = edge.twin,
                                oppositeFace = twinEdge.face;
                                oppositeFace.mark === Visible && (oppositeFace.distanceToPoint(eyePoint) > this.tolerance ? this.computeHorizon(eyePoint, twinEdge, oppositeFace, horizon) : horizon.push(edge)),
                                edge = edge.next
                        ...
                        addNewFaces: function (eyeVertex, horizon) {
                            this.newFaces = [];
                            for (var firstSideEdge = null, previousSideEdge = null, i = 0; i < horizon.length; i++) {
                                var horizonEdge = horizon[i],
                                sideEdge = this.addAdjoiningFace(eyeVertex, horizonEdge);
                                null === firstSideEdge ? firstSideEdge = sideEdge : sideEdge.next.setTwin(previousSideEdge),
                                this.newFaces.push(sideEdge.face),
                                previousSideEdge = sideEdge
                            }
                            return firstSideEdge.next.setTwin(previousSideEdge),
                            this
                        },
                        ...
                        compute: function () {
                            var vertex;
                            for (this.computeInitialHull(); void 0 !== (vertex = this.nextVertexToAdd()); )
                    ...
                    Object.assign(Face, {
                        create: function (a, b, c) {
                            var face = new Face,
                            e0 = new HalfEdge(a, face),
                            e1 = new HalfEdge(b, face),
                            e2 = new HalfEdge(c, face);
                            return e0.next = e2.prev = e1,
                            e1.next = e0.prev = e2,
                            e2.next = e1.prev = e0,
                            face.edge = e0,
                            face.compute()
                    ...
                    Object.assign(Face.prototype, {
                        ...
                        compute: function () {
                            void 0 === triangle && (triangle = new three.Triangle);
                            var a = this.edge.tail(),
                            b = this.edge.head(),
                            c = this.edge.next.head();
                            return triangle.set(a.point, b.point, c.point),
                    ...
                    Object.assign(HalfEdge.prototype, {
                        ...
                        length: function () {
                            var head = this.head(),
                            tail = this.tail();
                            return null !== tail ? tail.point.distanceTo(head.point) : -1
                        },
                        lengthSquared: function () {
                            var head = this.head(),
                            tail = this.tail();
                            return null !== tail ? tail.point.distanceToSquared(head.point) : -1
                        },
                        setTwin: function (edge) {
                            return this.twin = edge,
                            edge.twin = this,
                            this
                        }
                    }),
                    Object.assign(VertexList.prototype, {
                        ...
                        insertBefore: function (target, vertex) {
                            return vertex.prev = target.prev,
                            vertex.next = target,
                            null === vertex.prev ? this.head = vertex : vertex.prev.next = vertex,
                            target.prev = vertex,
                            this
                        },
                        insertAfter: function (target, vertex) {
                            return vertex.prev = target,
                            vertex.next = target.next,
                            null === vertex.next ? this.tail = vertex : vertex.next.prev = vertex,
                            target.next = vertex,
                            this
                        },
                        append: function (vertex) {
                            return null === this.head ? this.head = vertex : this.tail.next = vertex,
                        ...
                        appendChain: function (vertex) {
                            for (null === this.head ? this.head = vertex : this.tail.next = vertex, vertex.prev = this.tail; null !== vertex.next; )
                                vertex = vertex.next;
                            return this.tail = vertex,
                            this
                        },
                        remove: function (vertex) {
                            return null === vertex.prev ? this.head = vertex.next : vertex.prev.next = vertex.next,
                            null === vertex.next ? this.tail = vertex.prev : vertex.next.prev = vertex.prev,
                            this
                        },
                        removeSubList: function (a, b) {
                            return null === a.prev ? this.head = b.next : a.prev.next = b.next,
                ...
                function getGeometry(object) {
                    const meshes = function (object) {
                        const meshes = [];
                        return object.traverse(function (o) {
                            o.isMesh && meshes.push(o)
                        }),
                        meshes
                    }
                    (object);
                    ...
                    return function (geometries) {
                        ...
                        for (let i = 0; i < geometries.length; i++) {
                            ...
                            position && 3 === position.itemSize && (vertexCount += position.count)
                        }
                        const positionArray = new Float32Array(3 * vertexCount);
                        let positionOffset = 0;
                        for (let i = 0; i < geometries.length; i++) {
                            const position = geometries[i].attributes.position;
                            if (position && 3 === position.itemSize)
                                for (let j = 0; j < position.count; j++)
                                    positionArray[positionOffset++] = position.getX(j), positionArray[positionOffset++] = position.getY(j), positionArray[positionOffset++] = position.getZ(j)
                        }
                ...
                function normalizeGeometry(mesh) {
                    ...
                    return geometry = geometry.toBufferGeometry ? geometry.toBufferGeometry() : geometry.clone(),
                ...
                function getVertices(geometry) {
                    ...
                    vertices = new Float32Array(3 * position.count);
                    for (let i = 0; i < position.count; i++)
                        vertices[3 * i] = position.getX(i), vertices[3 * i + 1] = position.getY(i), vertices[3 * i + 2] = position.getZ(i);
                    return vertices
                }
                ...
                function simplifyGeometry(geometry, tolerance = 1e-4) {
                    ...
                    vertexCount = indices ? indices.count : positions.count;
                    let nextIndex = 0;
                    const newIndices = [],
                    newPositions = [],
                    decimalShift = Math.log10(1 / tolerance),
                    ...
                    for (let i = 0; i < vertexCount; i++) {
                        ...
                        (hash += ~~(positions.getZ(index) * shiftMultiplier) + ",")in hashToIndex ? newIndices.push(hashToIndex[hash]) : (newPositions.push(positions.getX(index)), newPositions.push(positions.getY(index)), newPositions.push(positions.getZ(index)), hashToIndex[hash] = nextIndex, newIndices.push(nextIndex), nextIndex++)
                    }
                    ...
                    return result.setAttribute("position", positionAttribute),
                ...
                (ShapeType = exports.ShapeType || (exports.ShapeType = {})).BOX = "Box",
                ...
                const getShapeParameters = function (object, options = {}) {
                    ...
                    if (options.type === exports.ShapeType.CYLINDER)
                        return function (object, options) {
                            ...
                            radius = .5 * Math.max(getComponent(box.max, minorAxes[0]) - getComponent(box.min, minorAxes[0]), getComponent(box.max, minorAxes[1]) - getComponent(box.min, minorAxes[1])),
                            eulerX = "y" === majorAxis ? PI_2 : 0,
                            eulerY = "z" === majorAxis ? PI_2 : 0;
                            return {
                    ...
                    (object, options);
                    if (options.type === exports.ShapeType.SPHERE)
                        return function (object, options) {
                    ...
                    (object, options);
                    if (options.type === exports.ShapeType.HULL)
                        return function (object) {
                            const geometry = getGeometry(object);
                            if (!geometry)
                                return null;
                            for (let i = 0; i < geometry.attributes.position.count; i++)
                                geometry.attributes.position.setXYZ(i, geometry.attributes.position.getX(i) + 1e-4 * (Math.random() - .5), geometry.attributes.position.getY(i) + 1e-4 * (Math.random() - .5), geometry.attributes.position.getZ(i) + 1e-4 * (Math.random() - .5));
                            const hullFaces = (new ConvexHull).setFromObject(new three.Mesh(geometry)).faces,
                            vertices = [],
                            faces = [];
                            ...
                            return verticesTypedArray.set(vertices), {
                    ...
                    (object);
                    if (options.type === exports.ShapeType.MESH)
                        return (geometry = getGeometry(object)) ? function (geometry) {
                    ...
                    case "PlaneBufferGeometry":
                        return function (geometry) {
                            ...
                            return {
                                ...
                                params: {
                                    x: (box.max.x - box.min.x) / 2 || .1,
                                    y: (box.max.y - box.min.y) / 2 || .1,
                                    z: (box.max.z - box.min.z) / 2 || .1
                                }
                            }
                        }
                        (geometry);
                ...
                function getBoundingBoxParameters(object) {
                    ...
                    return {
                        ...
                        offset: localPosition.lengthSq() ? new cannonEs.Vec3(localPosition.x, localPosition.y, localPosition.z) : void 0
                    }
                }
                exports.getShapeParameters = getShapeParameters,
                exports.threeToCannon = function (object, options = {}) {
                    ...
                    let shape;
                    return {
                        shape: shape = type === exports.ShapeType.BOX ? function (params) {
                            const {
                                x: x,
                                y: y,
                                z: z
                            } = params;
                            return new cannonEs.Box(new cannonEs.Vec3(x, y, z))
                        }
                        (params) : type === exports.ShapeType.CYLINDER ? function (params) {
                            const {
                                radiusTop: radiusTop,
                            ...
                            shape = new cannonEs.Cylinder(radiusTop, radiusBottom, height, segments);
                            return shape.radiusTop = radiusBottom,
                            shape.radiusBottom = radiusBottom,
                            shape.height = height,
                            shape.numSegments = segments,
                            shape
                        }
                        (params) : type === exports.ShapeType.SPHERE ? function (params) {
                            return new cannonEs.Sphere(params.radius)
                        }
                        (params) : type === exports.ShapeType.HULL ? function (params) {
                            const {
                                faces: faces,
                            ...
                            return new cannonEs.ConvexPolyhedron({
                                faces: faces,
                                vertices: vertices
                            })
                        }
    ...
    9: [function (require, module, exports) {
            ...
            module.exports = AFRAME.registerComponent("ammo-constraint", {
                ...
                update: function () {
                    ...
                    data = this.data;
                    this.remove(),
                    el.body && data.target.body ? (this.constraint = this.createConstraint(), this.system.addConstraint(this.constraint)) : (el.body ? data.target : el).addEventListener("body-loaded", this.update.bind(this, {}), {
                        once: !0
                    })
                },
                createConstraint: function () {
                    ...
                    case CONSTRAINT.SPRING: {
                            for (var i in constraint = new Ammo.btGeneric6DofSpringConstraint(body, targetBody, bodyTransform, targetTransform, !0), [0, 1, 2, 3, 4, 5])
                                constraint.enableSpring(1, !0), constraint.setStiffness(1, this.data.stiffness), constraint.setDamping(1, this.data.damping);
                            const upper = new Ammo.btVector3(-1, -1, -1),
                            lower = new Ammo.btVector3(1, 1, 1);
                    ...
                    return Ammo.destroy(bodyTransform),
            ...
            let AmmoBody = {
                ...
                initBody: function () {
                    ...
                    return function () {
                        ...
                        this.compoundShape = new Ammo.btCompoundShape(!0),
                        this.rbInfo = new Ammo.btRigidBodyConstructionInfo(data.mass, this.motionState, this.compoundShape, this.localInertia),
                        this.rbInfo.m_restitution = ((num, min, max) => Math.min(Math.max(num, min), max))(this.data.restitution, 0, 1),
                        ...
                        almostEqualsBtVector3(.001, gravity, this.system.driver.physicsWorld.getGravity()) || (this.body.setGravity(gravity), this.body.setFlags(RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY)),
                ...
                _updateShapes: function () {
                    ...
                    return function () {
                        ...
                        if (this.data.scaleAutoUpdate && this.prevScale && !almostEqualsVector3(.001, obj.scale, this.prevScale) && (this.prevScale.copy(obj.scale), updated = !0, this.localScaling.setValue(this.prevScale.x, this.prevScale.y, this.prevScale.z), this.compoundShape.setLocalScaling(this.localScaling)), this.shapeComponentsChanged) {
                            ...
                            this.data.type === TYPE.DYNAMIC && this.updateMass(),
                ...
                update: function (prevData) {
                    if (this.isLoaded) {
                        ...
                        prevData.restitution != data.restitution && console.warn("ammo-body restitution cannot be updated from its initial value.")
                    }
                },
                remove: function () {
                    this.triMesh && Ammo.destroy(this.triMesh),
                    this.localScaling && Ammo.destroy(this.localScaling),
                    this.compoundShape && Ammo.destroy(this.compoundShape),
                    this.body && (Ammo.destroy(this.body), delete this.body),
                ...
                beforeStep: function () {
                    this._updateShapes(),
                    this.data.type === TYPE.KINEMATIC && this.syncToPhysics()
                },
                step: function () {
                ...
                syncToPhysics: function () {
                    ...
                    return function () {
                        ...
                        parentEl.isScene ? (v.copy(el.object3D.position), q.copy(el.object3D.quaternion)) : (el.object3D.getWorldPosition(v), el.object3D.getWorldQuaternion(q));
    ...
    initBody: function () {
        ...
        if (this.body = new CANNON.Body({
            ...
            var options = "auto" === data.shape ? void 0 : AFRAME.utils.extend({}, this.data, {
                ...
                return threeToCannon(object, options)
            }
            (this.el.object3D, options);
            if (!shape)
            ...
            this.hasShape && this.el.emit("body-loaded", {
                body: this.el.body
            })
        },
        ...
        tick: function () {
            this.shouldUpdateBody && (this._pause(), this.hasShape = !0, this._play(), this.el.emit("body-loaded", {
                    body: this.el.body
                }), this.shouldUpdateBody = !1),
            this.shouldUpdateWireframe && (this.createWireframe(this.body), this.shouldUpdateWireframe = !1)
        },
        play: function () {
            this._play()
        },
        _play: function () {
            this.hasShape && (this.syncToPhysics(), this.system.addComponent(this), this.system.addBody(this.body), this.wireframe && this.el.sceneEl.object3D.add(this.wireframe))
        },
        pause: function () {
            this._pause()
        },
        _pause: function () {
            this.hasShape && (this.system.removeComponent(this), this.body && this.system.removeBody(this.body), this.wireframe && this.el.sceneEl.object3D.remove(this.wireframe))
        },
        update: function (prevData) {
            if (this.body) {
                var data = this.data;
                ...
                "dynamic" === data.type && (this.body.linearDamping = data.linearDamping, this.body.angularDamping = data.angularDamping),
                data.mass !== prevData.mass && this.body.updateMassProperties(),
                this.body.updateProperties && this.body.updateProperties()
            }
        },
        remove: function () {
            this.body && (delete this.body.el, delete this.body),
            delete this.el.body,
        ...
        createWireframe: function (body) {
            var offset,
            mesh;
            this.wireframe && (this.el.sceneEl.object3D.remove(this.wireframe), delete this.wireframe),
            ...
            for (var orientation = new THREE.Quaternion, i = 0; i < this.body.shapes.length; i++) {
                ...
                orientation && wireframe.quaternion.copy(orientation),
        ...
        module.exports = AFRAME.registerComponent("velocity", {
            ...
            afterStep: function (t, dt) {
                if (dt) {
                    ...
                    this.el.object3D.position.set(position.x + velocity.x * dt / 1e3, position.y + velocity.y * dt / 1e3, position.z + velocity.z * dt / 1e3)
                }
            }
        })
    }, {}
...
17: [function (require, module, exports) {
        ...
        var AmmoShape = {
            ...
            init: function () {
                ...
                let bodyEl = this.el;
                for (this.body = bodyEl.components["ammo-body"] || null; !this.body && bodyEl.parentNode != this.el.sceneEl; )
                    (bodyEl = bodyEl.parentNode)
                        .components["ammo-body"] && (this.body = bodyEl.components["ammo-body"]);
                        if (this.body) {
                            if (this.data.fit !== FIT.MANUAL) {
                                if (!this.el.object3DMap.mesh)
                                    return void console.error("Cannot use FIT.ALL without object3DMap.mesh");
...
initShape: function () {
    this.bodyEl = this.el;
    for (var bodyType = this._findType(this.bodyEl), data = this.data; !bodyType && this.bodyEl.parentNode != this.el.sceneEl; )
        this.bodyEl = this.bodyEl.parentNode, bodyType = this._findType(this.bodyEl);
    if (bodyType) {
        var shape,
        offset,
        orientation,
...
19: [function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent("spring", {
            ...
            updateSpring: function (oldData) {
                if (this.spring) {
                    ...
                    Object.keys(data).forEach(function (attr) {
                        if (data[attr] !== oldData[attr]) {
                            if ("target" === attr)
                                return void(spring.bodyB = data.target.body);
                ...
                remove: function () {
                    this.spring && delete this.spring,
                    this.spring = null
                }
            })
    }, {
...
21: [function (require, module, exports) {
        ...
        AmmoDriver.prototype.init = function (worldConfig) {
            return new Promise(resolve => {
                AmmoModule().then(result => {
                    Ammo = result,
                    this.epsilon = worldConfig.epsilon || 1e-5,
                    ...
                    this.physicsWorld.setForceUpdateAllAabbs(!1),
        ...
        AmmoDriver.prototype.getDebugDrawer = function (scene, options) {
            return this.debugDrawer || ((options = options || {}).debugDrawMode = options.debugDrawMode || this.debugDrawMode, this.debugDrawer = new THREE.AmmoDebugDrawer(scene, this.physicsWorld, options)),
            this.debugDrawer
        }
    }, {
        "./driver": 22
...
26: [function (require, module, exports) {
    ...
    27: [function (require, module, exports) {
            ...
            WorkerDriver.prototype.step = function () {
                if (this.interpolate) {
                    for (var prevFrame = this.frameBuffer[0], nextFrame = this.frameBuffer[1], timestamp = performance.now(); prevFrame && nextFrame && timestamp - prevFrame.timestamp > this.frameDelay; )
                        this.frameBuffer.shift() , prevFrame = this.frameBuffer[0], nextFrame = this.frameBuffer[1];
                        if (prevFrame && nextFrame) {
                            var mix = (timestamp - prevFrame.timestamp) / this.frameDelay;
                            for (var id in mix = (mix - (1 - 1 / this.interpBufferSize)) * this.interpBufferSize, prevFrame.bodies)
                                prevFrame.bodies.hasOwnProperty(id)
                                     && nextFrame.bodies.hasOwnProperty(id)
                            ...
                            WorkerDriver.prototype._onMessage = function (event) {
                                if (event.data.type === Event.STEP) {
                                    ...
                                    if (this.contacts = event.data.contacts, this.interpolate)
                                    ...
                                    if (event.data.type !== Event.COLLIDE)
                                    ...
                                    if (!body._listeners || !body._listeners.collide)
                                        return;
            ...
            default:
                C_MAT.contactEquationRelaxation
            },
            frictionEquationStiffness: {
            default:
                C_MAT.frictionEquationStiffness
            },
            frictionEquationRegularization: {
            default:
                C_MAT.frictionEquationRegularization
            },
            maxInterval: {
            default:
                4 / 60
            ...
            debugDrawMode: {
            default:
                THREE.AmmoDebugConstants.NoDebug
            },
            maxSubSteps: {
            default:
                4
        ...
        async init() {
            var data = this.data;
            switch (this.debug = data.debug, this.initStats(), this.callbacks = {
                    beforeStep: [],
                    step: [],
                    afterStep: []
            ...
            this.initialized = !0,
            this.debug && this.setDebug(!0)
        },
        initStats() {
            if (this.statsToConsole = this.data.stats.includes("console"), this.statsToEvents = this.data.stats.includes("events"), this.statsToPanel = this.data.stats.includes("panel"), this.statsToConsole || this.statsToEvents || this.statsToPanel) {
                this.trackPerf = !0,
                this.tickCounter = 0,
                this.statsTickData = {},
                this.statsBodyData = {},
                this.countBodies = {
                    ...
                    local: () => this.countBodiesCannon(!1),
                    worker: () => this.countBodiesCannon(!0)
                },
        ...
        tick: function (t, dt) {
            ...
            for (i = 0; i < this.callbacks.beforeStep.length; i++)
                ...
                this.driver.step(Math.min(dt / 1e3, this.data.maxInterval));
                ...
                for (i = 0; i < callbacks.step.length; i++)
                    ...
                    for (i = 0; i < callbacks.afterStep.length; i++)
                        ...
                        if (this.trackPerf) {
                            ...
                            this.tickCounter++,
                            100 === this.tickCounter && (this.countBodies[this.data.driver](), this.statsToConsole && console.log("Physics body stats:", this.statsBodyData), (this.statsToEvents || this.statsToPanel) && this.el.emit("physics-body-data", this.statsBodyData), this.tickCounter = 0)
                        }
                    },
                    countBodiesAmmo() {
                        ...
                        this.driver.els.forEach(el => {
                            const property = this.bodyTypeToStatsPropertyMap.ammo[(el = el, el.components["ammo-body"].data.type)];
                            statsData[property]++
                        })
                    },
                    countBodiesCannon(worker) {
                        ...
                        statsData.staticBodies = 0,
                        statsData.dynamicBodies = 0,
                        (worker ? Object.values(this.driver.bodies) : this.driver.world.bodies).forEach(body => {
                    ...
                    setDebug: function (debug) {
                        this.debug = debug,
                        "ammo" === this.data.driver && this.initialized && (debug && !this.debugDrawer ? (this.debugDrawer = this.driver.getDebugDrawer(this.el.object3D), this.debugDrawer.enable()) : this.debugDrawer && (this.debugDrawer.disable(), this.debugDrawer = null))
                    },
                    ...
                    removeBody: function (body) {
                        ...
                        "local" !== this.data.driver && "worker" !== this.data.driver || (body.removeEventListener("collide", this.listeners[body.id]), delete this.listeners[body.id], body.applyImpulse = body.__applyImpulse, delete body.__applyImpulse, body.applyForce = body.__applyForce, delete body.__applyForce, delete body.updateProperties)
                    },
            ...
            "./constants": 20,
            "./drivers/ammo-driver": 21,
            "./drivers/local-driver": 24,
            "./drivers/network-driver": 25,
            "./drivers/worker-driver": 27,
            "aframe-stats-panel": 3,
            "cannon-es": 5
        }
    ],
    30: [function (require, module, exports) {
            module.exports.slerp = function (a, b, t) {
                ...
                if (!(cosHalfTheta < 0))
                    return b;
                if ((a = a.slice())[3] = -b[3], a[0] = -b[0], a[1] = -b[1], a[2] = -b[2], (cosHalfTheta = -cosHalfTheta) >= 1)
                    return a[3] = w, a[0] = x, a[1] = y, a[2] = z, this;
                var sinHalfTheta = Math.sqrt(1 - cosHalfTheta * cosHalfTheta);
                if (Math.abs(sinHalfTheta) < .001)
                    return a[3] = .5 * (w + a[3]), a[0] = .5 * (x + a[0]), a[1] = .5 * (y + a[1]), a[2] = .5 * (z + a[2]), this;
                ...
                function deserializeShape(message) {
                    ...
                    module.exports.deserializeBody = function (message) {
                        ...
                        module.exports.deserializeConstraint = function (message, bodies) {
                            var constraint,
                            TypedConstraint = CANNON[message.type],
